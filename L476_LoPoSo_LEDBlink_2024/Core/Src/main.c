...
// Experience 5.6.7.8 ne marchent pas
...
uint8_t cptr_transmit = 1; //Compteur du nombre de transmit
...
const char* entete_message = "MARQUES_PRALUS";
...
void SysTick_Handler()
{
	...
	if	( subticks == 0 ){
		...
		//if (expe < 4) {
		//	nRF24_SetPowerMode(nRF24_PWR_DOWN); // mode low power
		//}
	}
    else if	( subticks == 5 ){
    	LED_GREEN(0);
